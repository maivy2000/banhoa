...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div >
        Tìm kiếm từ khóa: <asp:Label ID="Label1" runat="server" Text="" ForeColor="#ff0066"></asp:Label>
...
<asp:Label ID="TENMHLabel" CssClass="tenhoa" runat="server" Text='<%# Eval("TENMH") %>' />
                    ...
                    </asp:LinkButton><button class="nutchuadep"><asp:LinkButton ID="LinkButton2" runat="server" CommandName="cart" CommandArgument='<%# Eval("MAMH") %>'>Cart</asp:LinkButton></button >
