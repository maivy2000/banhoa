...
public partial class Flower : System.Web.UI.Page
{
    ...
    {
        //SqlDataSource1.SelectCommand = "SELECT * FROM [HANGHOA] WHERE [MAMH] ='" + "MH01" + "' OR  [MAMH] ='" + "MH02" + "' OR  [MAMH] ='" + "MH03" +
        //    "' OR [MAMH] = '" + "MH04" + "' OR  [MAMH] ='" + "MH05" + "' OR  [MAMH] ='" + "MH06" + "'";
        SqlDataSource1.SelectCommand = "SELECT * FROM [HANGHOA] WHERE [MAPL]='" + "L01" + "' ";
