<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Flower.aspx.cs" Inherits="Flower" %>
...
<asp:Label ID="TENMHLabel" CssClass="tenhoa" runat="server" Text='<%# Eval("TENMH") %>' />
                    ...
                    </asp:LinkButton><button class="nutchuadep"><asp:LinkButton runat="server" CommandName='<%# Eval("MAMH") %>' >Cart</asp:LinkButton></button >
